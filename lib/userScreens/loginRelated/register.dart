...
//        }
//
//        BotToast.showText(text: "Welcome $userName");
//      }
//      //   currentUser = User.fromDocument(doc);
//    }
//  }
...
//      DocumentSnapshot doc = await userRef.document(googleUser.id).get();
//
...
//        userRef.document(googleUser.id).setData({
//          "id": googleUser.id,
...
////        await preferences.setString('email', doc['email']);
//
//        doc = await userRef.document(googleUser.id).get();
//        print(doc.data);
//        currentUser = User.fromDocument(doc);
//        if (doc.exists) {
//          setState(() {
...
////            context,
////            MaterialPageRoute(
////                builder: (context) => KannapyStore(currentUserInStore: currentUser,
////                    )));
//        //    });
//      }
//      // currentUser = User.fromDocument(doc);
